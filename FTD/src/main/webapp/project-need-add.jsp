...
<body leftmargin="8" topmargin="8" background='skin/images/allbg.gif'>
	...
	<form name="form2" method="post" action="addProjectNeedAction">
		...
		<table width="98%" border="0" cellpadding="2" cellspacing="1"
			...
			<tr>
				...
				<td align='left' bgcolor="#FFFFFF"
					...
					<select id="pn.project.projectID" name="pn.project.projectID">
			...
			<tr>
				...
				<td align='left' bgcolor="#FFFFFF"
					onMouseMove="javascript:this.bgColor='#FCFDEE';"
					onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22"><input type="text" id="needName" name="needName"/></td>
			</tr>
			<tr>
			...
			<tr bgcolor="#FAFAF1">
				<td height="28" colspan=4 align=center>&nbsp; 
					<input type="submit" class="coolbg" value="保存"> 
				 	<a href="projectNeedListAction" class="coolbg">返回</a>
				</td>
			</tr>
		</table>
