		...
		<table width="98%" border="0" cellpadding="2" cellspacing="1"
			...
			<c:forEach items="${taskList }" var="item">
				<tr align='center' bgcolor="#FFFFFF"
					...
					<a href="lookTaskAction?taskID=${item.taskID }">查看详情</a>
					</td>
				</tr>
			</c:forEach>
			...
			<tr align="right" bgcolor="#EEF4EA">
				<td height="36" colspan="12" align="center">
					<!--翻页代码 : action还没写 --> <a
					href="${pageContext.request.contextPath }/lookMyTaskAction?pagenum=1">首页</a> <a
					href="${pageContext.request.contextPath }/lookMyTaskAction?pagenum=${p.currentPage - 1}">上页</a>
					<a
					href="${pageContext.request.contextPath }/lookMyTaskAction?pagenum=${p.currentPage + 1}">下页</a>
					<a href="${pageContext.request.contextPath }/lookMyTaskAction?pagenum=${p.pages }">末页</a>
				</td>
			</tr>
			<tr align="right" bgcolor="#EEF4EA">
