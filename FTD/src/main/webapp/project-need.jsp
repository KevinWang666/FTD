...
<script type="text/javascript">
	function selAll() {
		var items = document.form2.needIDs;
...
<body leftmargin="8" topmargin="8" background='skin/images/allbg.gif'>
		...
		<tr>
			<td height="26" background="skin/images/newlinebg3.gif">
				<table width="58%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td>当前位置:项目管理>>需求分析管理</td>
						<td><input type='button' class="coolbg np"
							onClick="location='jump2AddProjectNeedAction';" value='添加新项目需求' /></td>
					</tr>
				</table>
			</td>
		</tr>
					...
					<table border='0' cellpadding='0' cellspacing='0'>
						<tr>
							...
							<td width='160'><select name='cid' style='width: 150'>
									...
									<option value='needName'>标题</option>
	...
	<!--  内容列表   -->
	<form name="form2" method="post" action="deleteProjectNeedAction">
		...
		<table width="98%" border="0" cellpadding="2" cellspacing="1"
			...
			<tr align='center' bgcolor="#FFFFFF"
				...
				<td><input name="needIDs" type="checkbox" id="needIDs" value="${item.needID }"
					class="np"></td>
				<td>${item.needID }</td>
				<td>${item.needName }</td>
				...
				<td><a href="jump2UpdateProjectNeedAction?needID=${item.needID }">编辑</a> | <a
					href="lookProjectNeedAction?needID=${item.needID }">查看详情</a></td>
			</tr>
			</c:forEach>
			...
			<tr align="right" bgcolor="#EEF4EA">
				<td height="36" colspan="12" align="center">
					<!--翻页代码 --> 
					<a href="${pageContext.request.contextPath }/projectNeedListAction?pagenum=1">首页</a> 
					<a href="${pageContext.request.contextPath }/projectNeedListAction?pagenum=${p.currentPage - 1}">上页</a>
					<a href="${pageContext.request.contextPath }/projectNeedListAction?pagenum=${p.currentPage + 1}">下页</a>
					<a href="${pageContext.request.contextPath }/projectNeedListAction?pagenum=${p.pages }">末页</a>
				</td>
			</tr>
			<tr align="right" bgcolor="#EEF4EA">
