		...
		<table width="98%" border="0" cellpadding="2" cellspacing="1"
			...
			<tr>
				...
				<td align='left' bgcolor="#FFFFFF"
					...
					onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22"><select><option
							value=1>张含馨--初级程序员</option>
						<option value=1>张&nbsp;&nbsp;伟--中级程序员</option>
						<option value=1>孙传杰--项目经理</option></select></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan=3 align='left' bgcolor="#FFFFFF"
					onMouseMove="javascript:this.bgColor='#FCFDEE';"
					onMouseOut="javascript:this.bgColor='#FFFFFF';"><input
					type="file" /></td>
			</tr>
			...
			<tr bgcolor="#FAFAF1">
				<td height="28" colspan=4 align=center>&nbsp; <a
					href="message-seed.jsp" class="coolbg">保存</a>
				</td>
			</tr>
		</table>
