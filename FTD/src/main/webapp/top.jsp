	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0"
		...
		<tr>
			<td width='20%' height="60"><img
				src="skin/images/frame/logo.gif" /></td>
			<td width='80%' align="right" valign="bottom">
				<table width="750" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td align="right" height="26"
							style="padding-right: 10px; line-height: 26px;">您好：<span
							class="username"><font color="red">${currentUser.truename }</font></span>，欢迎使用项目平台管理系统！

							[<a href="index.jsp" target="_top">主页</a>] [<a
							href="modpassword.jsp" target="_blank">修改密码</a>] [<a
							href="javascript:void(0);"
							onClick="parent.location.href='logoutAction'" target="_login">注销退出</a>]&nbsp;
						</td>
					</tr>
					<tr>
						<td align="right" height="34" class="rmain"></td>
					</tr>
				</table>
			</td>
		</tr>
