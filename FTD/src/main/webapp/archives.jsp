				...
				<table width="98%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td align="center"><input type='button' class="coolbg np"
							onClick="location='';" value='添加文档' /> <input type='button'
							class="coolbg np" onClick="location='';" value='我的文档' /> <input
							type='button' class='coolbg np' onClick="location='';"
							value='稿件审核' /> <input type='button' class="coolbg np"
							onClick="location='';" value='栏目管理' /> <input type='button'
							class="coolbg np" onClick="location='';" value='更新列表' /> <input
							type='button' class="coolbg np" onClick="location='';"
							value='更新文档' /> <input type='button' class="coolbg np"
							onClick="location='';" value='文章回收站' /></td>
					</tr>
				</table>
			</td>
		</tr>
	...
	<form name="form2">
		...
		<table width="98%" border="0" cellpadding="2" cellspacing="1"
			...
			<tr align='center' bgcolor="#FFFFFF"
				...
				onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
				<td>5</td>
				<td><input name="id" type="checkbox" id="id" value="100"
					class="np"></td>
			...
			<tr align='center' bgcolor="#FFFFFF"
				...
				onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
				<td>5</td>
				<td><input name="id" type="checkbox" id="id" value="99"
					class="np"></td>
			...
			<tr align='center' bgcolor="#FFFFFF"
				...
				onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
				<td>5</td>
				<td><input name="id" type="checkbox" id="id" value="98"
					class="np"></td>
			...
			<tr align='center' bgcolor="#FFFFFF"
				...
				onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
				<td>5</td>
				<td><input name="id" type="checkbox" id="id" value="97"
					class="np"></td>
			...
			<tr align='center' bgcolor="#FFFFFF"
				...
				onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
				<td>5</td>
				<td><input name="id" type="checkbox" id="id" value="96"
					class="np"></td>
			...
			<tr align='center' bgcolor="#FFFFFF"
				...
				onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
				<td>5</td>
				<td><input name="id" type="checkbox" id="id" value="95"
					class="np"></td>
			...
			<tr align='center' bgcolor="#FFFFFF"
				...
				onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
				<td>5</td>
				<td><input name="id" type="checkbox" id="id" value="94"
					class="np"></td>
			...
			<tr align='center' bgcolor="#FFFFFF"
				...
				onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
				<td>5</td>
				<td><input name="id" type="checkbox" id="id" value="93"
					class="np"></td>
			...
			<tr align='center' bgcolor="#FFFFFF"
				...
				onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
				<td>5</td>
				<td><input name="id" type="checkbox" id="id" value="92"
					class="np"></td>
			...
			<tr bgcolor="#FAFAF1">
				<td height="28" colspan="10">&nbsp; <a
					href="javascript:selAll()" class="coolbg">全选</a> <a
					href="javascript:noSelAll()" class="coolbg">取消</a> <a
					href="javascript:updateArc(0)" class="coolbg">&nbsp;更新&nbsp;</a> <a
					href="javascript:checkArc(0)" class="coolbg">&nbsp;审核&nbsp;</a> <a
					href="javascript:adArc(0)" class="coolbg">&nbsp;推荐&nbsp;</a> <a
					href="javascript:moveArc(0)" class="coolbg">&nbsp;移动&nbsp;</a> <a
