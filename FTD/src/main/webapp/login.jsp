...
<BODY bgColor=#eef8e0 leftMargin=0 topMargin=0 MARGINWIDTH="0"
	MARGINHEIGHT="0">
	<FORM name=adminlogin action=loginAction method=post>
			...
			<TBODY>
											...
											<TBODY>
												...
												<TR>
													...
													<TD><INPUT class=regtxt title=请填写密码 type=password
														maxLength=16 size=16  name=pwd></TD>
												</TR>
												<TR>
													<TD align="center" width="81"><FONT color=#ffffff>验证码：</FONT></TD>
													<TD><INPUT class=regtxt title=请填写验证码 maxLength=50
														size=16 name=path> <INPUT type=hidden
				...
				<TR>
					...
					<TD><INPUT title=登录项目平台管理系统 type=image height=48 alt=""
						width=86 src="images/crm_17.gif" name=image></TD>
