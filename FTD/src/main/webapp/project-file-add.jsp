...
<body leftmargin="8" topmargin="8" background='skin/images/allbg.gif'>
	...
	<form name="form2" method="post" action="addProjectFileAction">
		...
		<table width="98%" border="0" cellpadding="2" cellspacing="1"
			...
			<tr>
				...
				<td align='left' bgcolor="#FFFFFF"
					...
					<select id="pfile.project.projectID" name="pfile.project.projectID">
			...
			<tr>
				...
				<td align='left' bgcolor="#FFFFFF"
					...
					size="26" type="text" id="filename" name="filename"/></td>
			</tr>
			<tr>
				...
				<td align='left' bgcolor="#FFFFFF"
					onMouseMove="javascript:this.bgColor='#FCFDEE';"
					onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22"><input
					size="52" type="text" id="fileDesc" name="fileDesc"/></td>
			</tr>
			<tr>
				...
				<td align='left' bgcolor="#FFFFFF"
					onMouseMove="javascript:this.bgColor='#FCFDEE';"
					onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22"><input
					type="file" id="upload" name="upload"/></td>
			</tr>
