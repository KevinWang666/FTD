...
<body leftmargin="8" topmargin="8" background='skin/images/allbg.gif'>
	...
	<!-- action -->
	<form name="form2" method="post" action="addRoleAction">
		...
		<table width="98%" border="0" cellpadding="2" cellspacing="1"
			...
			<tr>
				...
				<td align='left' bgcolor="#FFFFFF"
					...
					type="text" id="roleNumber" name="roleNumber" /></td>
			</tr>
			<tr>
				...
				<td align='left' bgcolor="#FFFFFF"
					onMouseMove="javascript:this.bgColor='#FCFDEE';"
					onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22"><input
					type="text" id="roleName" name="roleName" /></td>
			</tr>
			<tr>
				...
				<td align='left' bgcolor="#FFFFFF"
					...
					<c:forEach items="${resourceList }"
						...
						<c:if test="${res.parent == null}">
							<input type="checkbox" checked  value="${res.resourceID }"  name="resourceList" />${res.resourceName }<br />
						<c:forEach items="${resourceList }" var="subRes">
								<c:if test="${subRes.parent.resourceID == res.resourceID}">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" checked="checked"  value="${subRes.resourceID }"  name="resourceList" />${subRes.resourceName} <br />
								</c:if>
							</c:forEach>
						</c:if>
					</c:forEach>
			...
			<tr bgcolor="#FAFAF1">
				...
				<a href="roleListAction" class="coolbg">返回</a>
				</td>
			</tr>
		</table>
